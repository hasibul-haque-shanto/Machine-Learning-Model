...
# definning major and minor claim respectively
dataset.loc[dataset['Endkosten'] > np.percentile(dataset['Endkosten'], 99), 'Anspruchsart'] = 1
dataset.loc[dataset['Endkosten'] <= np.percentile(dataset['Endkosten'], 99), 'Anspruchsart'] = 0 
